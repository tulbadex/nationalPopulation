...
class DatabaseSeeder extends Seeder
{
    ...
    {
      if (Schema::hasTable('l_g_as')) {
        DB::insert($this->formatQuery('lg'));
      }
    }

    /**
     * Seeds the wards table
     * @return void
     */
    public function seedWardTable()
    {
      if (Schema::hasTable('wards')) {
        DB::insert($this->formatQuery('wards'));
      }
    }

    public function seedCitizenTable()
    {
    ...
    {
      return "INSERT INTO l_g_as (id, state_id, name) VALUES
        (1, 1, 'Aba South'),
        (2, 1, 'Arochukwu'),
        (3, 1, 'Bende'),
        (4, 1, 'Ikwuano'),
    ...
    private function getWardQuery()
    {
      return "INSERT INTO wards (id, name, lga_id) VALUES
        (1, 'Ajeromi', 482 ),
        (2, 'Ifelodun', 482),
        (3, 'Alimosho', 483),
        (4, 'Agbado/Oke-Odo', 483),
        (5, 'Ayobo-Ipaja', 483),
        (6, 'Egbe-Idimu', 483),
        (7, 'Igando-Ikotun', 483),
        (8, 'Mosan Okunola', 483),
    ...
    private function getCitizenQuery()
    {
      return "INSERT INTO citizens (id, name, gender, address, phone, ward_id) VALUES
        (1, 'ibrahim', 'male', '4 olowu alley of freeman street lagos island', '08043567855', 1 ),
        (2, 'rashhed', 'male', '4 olowu alley of freeman street lagos island', '08043567855', 2),
        (3, 'bolanle', 'female', '4 olowu alley of freeman street lagos island', '08043567855', 1),
        (4, 'rasheedat', 'female', '4 olowu alley of freeman street lagos island', '08043567855', 2)";
    }
}
